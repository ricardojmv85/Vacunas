...
$SETTINGS["data_table"]='ganado'; // this is the default database name that we used
$SETTINGS["data_table2"]='ventas'; // this is the default database name that we used
